...
sys.path.append('../../')
from models.MLP.runner import Runner
...
def main():
    ...
    parser.add_argument('--data_fname', type=str, default='wvfIndexData.pkl', help='Name of the data file.')
    parser.add_argument('--batch_size', type=int, default=32, help='Batch size for the dataloaders.')
    parser.add_argument('--size', type=dict, default={'train': 0.8, 'val': 0.1, 'test': 0.1}, help='Size of the training, validation, and test sets.')
    ...
    parser.add_argument('--input_dim', type=int, default=1000, help='Input dimension of the data.')
