...
def main():
    ...
    parser.add_argument('--kernel_dim', type=int, default=5, help='Kernel dimension for the convolutional layers.')
    parser.add_argument('--stride', type=int, default=1, help='Stride for the convolutional layers.')
    parser.add_argument('--padding', type=int, default=2, help='Padding for the convolutional layers.')
